...
import {
  ...
  buildReviewerSafeConfigSnapshot,
} from "../reviewer-safe-config.js";
import {
  buildConfigSchema,
  lookupConfigSchema,
...
export const configHandlers: GatewayRequestHandlers = {
  "config.get": async ({ params, respond }) => {
    ...
    respond(
      true,
      buildReviewerSafeConfigSnapshot({ snapshot, uiHints: schema.uiHints }),
      undefined,
    );
  },
  ...
  "config.set": async ({ params, respond }) => {
    ...
    respond(
      true,
      {
        ...
        config: buildReviewerSafeConfigObject({
