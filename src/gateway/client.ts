...
export class GatewayClient {
  ...
  private pendingTransportErrorMessage: string | null = null;
  ...
  start() {
    ...
    this.ws = ws;
    this.pendingTransportErrorMessage = null;
    ...
    ws.on("close", (code, reason) => {
      const reasonText = rawDataToString(reason) || this.pendingTransportErrorMessage || "";
    ...
    ws.on("error", (err) => {
      ...
      if (!this.connectSent) {
        ...
        this.pendingTransportErrorMessage = message || this.pendingTransportErrorMessage;
      }
      if (!this.connectSent) {
